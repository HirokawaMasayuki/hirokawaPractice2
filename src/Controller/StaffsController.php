...
class StaffsController extends AppController
{
    ...
    public function index()
    {
        ...
        $this->set('staffs', $this->Staffs->find('all', ['conditions' => ['delete_flag' => '0']]));
        $this->set('entity',$this->Staffs->newEntity());
